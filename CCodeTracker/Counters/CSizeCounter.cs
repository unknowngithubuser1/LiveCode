...
using livecode.CCodeTracker.Language;
using livecode.ComponentBase.FilePoint;
using livecode.ComponentBase.Measures;

namespace livecode.CCodeTracker.Counters
{
    public class CSizeCounter : ICounter
    {
        private static CLOCCounter loc = new CLOCCounter();
