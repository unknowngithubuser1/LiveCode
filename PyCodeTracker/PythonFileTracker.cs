...
using livecode.PyCodeTracker.Counters;

namespace livecode.PyCodeTracker
{
    [Export(typeof(FileHook))]
    public class PythonFileTracker : FileHook
    {
        public PythonFileTracker()
        {
            Files = new List<CodeFile>();

            this.APIKey = PyTracker.key;
        }
        ...
        public override void MeasureCodeFiles<T>()
        {
            ...
            {
                MeasureCodeFiles(new PythonSizeCounter());
            }
        }
