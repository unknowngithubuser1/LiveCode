...
using livecode.PyCodeTracker.Language;

namespace livecode.PyCodeTracker.Counters
{
    public class PythonSizeCounter : ICounter
    {
        private static PythonLOCCounter loc = new PythonLOCCounter();
